...
public class SplashScreenDisplay : Display
{
    ...
    public void ZeroPlayer()
    {
        ...
        _gameManager.ResetGameWithNewAgents(new Agent[]{ _leftOptions[(int)Settings.AgentOne], _rightOptions[(int)Settings.AgentTwo] });        
    ...
    public void OnePlayer()
    {
        ...
        _gameManager.ResetGameWithNewAgents(new Agent[] { _leftOptions[(int)Settings.AgentOne] ,_rightHuman});        
        DisplaysManager.instance.ShowDisplay(DisplaysManager.instance.GameDisplay);
        _rotatingCamera.enabled = false;
    }
    ...
    {
        DisplaysManager.instance.ShowDisplay(DisplaysManager.instance.SettingsDisplay);
    }
